let items = {
    regenPotion: {frame:1, materials:['healthHerb','healthHerb']}, //done
	cooldownPotion: {frame:4, materials:['cooldownHerb','cooldownHerb']}, //done
	speedPotion: {frame:2, materials:['speedHerb','speedHerb']}, //done
	damagePotion: {frame:3, materials:['damageHerb','damageHerb']}, //done
