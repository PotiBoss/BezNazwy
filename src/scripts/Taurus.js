...
import initAnims from './AnimsTaurus'
...
export default class Taurus extends EnemyBase
{
	...
	chasePlayer()
	{
		this.anims.play('chargeBallAnim', true);
	...
	setupChargeLocation()
	{
		...
		{
			this.chargeLocation.x = this.myPlayer.x
			this.chargeLocation.y = this.myPlayer.y
		}
