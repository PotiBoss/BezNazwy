...
export default class UI extends Phaser.Scene
{
	...
	pressF5()
	{
		this.msg3 = ["Fates - Rulers of Destiny\nYou died but don't give up yet. You can try again to rewrite your fate by pressing magic button 'F5' or try to REFRESH it"];
	...
	gameCleared()
	{
		this.msg4 = ["Fates - Rulers of Destiny\nYou found the Celestial Doors... but your journey ends here for now you can try again by the pressing magic button 'F5' or try to REFRESH your adventure.\nTill the next time."];
	...
	hornyFirst()
	{
		this.msg6 = ["Crius - Titan God of Heavenly Constellations\nYou can use craft table above us to craft alchemic potions.You can gather herbs during your journey.I am sure you know how to use it."];
	...
	hornySecond()
	{
		this.msg7 = ["Crius - Titan God of Heavenly Constellations\nI once heard from Chronos about his vision. He told me that if you gather enough essence from killing monsters, portal to Celestial Instrument will open. He also fortold that they are seald behind Celestial Doors. "];
	...
	hornyThird()
	{
		this.msg8 = ["Crius - Titan God of Heavenly Constellations\nHere are some tips that will help you during your journey. When vital points of monster drop to zero they die. You can't get hurt if you don't get it. Remember to always be prepared by having potions. God Speed my little one."];
	...
	nothornySecond()
	{
		this.msg10 = ["Chronos - Embodiment of Time\nWe need you because we god are bound by rules of Myths. Story of God is writen in Myths and legends.We cannot break free from our destiny but your race exist by a fluke. That is why stories of humanity begining are not so inconsistent."];
